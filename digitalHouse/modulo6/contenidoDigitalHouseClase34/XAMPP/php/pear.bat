...
FOR %%x IN ("C:\comision52DH\digitalHouse\modulo6\contenidoDigitalHouseClase34\XAMPP\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\comision52DH\digitalHouse\modulo6\contenidoDigitalHouseClase34\XAMPP\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\comision52DH\digitalHouse\modulo6\contenidoDigitalHouseClase34\XAMPP\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\comision52DH\digitalHouse\modulo6\contenidoDigitalHouseClase34\XAMPP\php\php.exe"
